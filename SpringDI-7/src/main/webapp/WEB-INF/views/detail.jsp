				...
				<fieldset class="label-130 product_block">
					...
					<div>
						<label>商品ID</label> <input type="text" name="loginId"
							value=${product.getProduct_id() } readonly class="base-text">
					</div>
					<div>
					...
					<div>
						<label>カテゴリ</label> <input type="text" name="roleName"
							value=${product.getCategory() } readonly class="base-text">
					</div>
					<div>
						<label>商品説明</label>
				...
				<div>
					<div class="btns">
						...
						<input type="button" onclick="openModal()" value="削除"
							...
							onclick="location.href='update'" value="編集" class="basic_btn">
							</c:when>
							<c:otherwise>
